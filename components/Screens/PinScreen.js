    ...
    return (
      <View style={pinsStyles.container}>
        <View style={pinsStyles.noPinsContainer}>
          <Text style={pinsStyles.noPinsText}>
            You are not logged in. Please log in to view your pins.
          </Text>
        </View>
      </View>
    );
    ...
    <View style={pinsStyles.container}>
      ...
      <View style={pinsStyles.navigationContainer}>
        <TouchableOpacity onPress={() => setActiveTab("Current")}>
          <Text
            style={[
              pinsStyles.navigationText,
              activeTab === "Current" && pinsStyles.activeNavigationText,
            ]}
          >
            Current
          </Text>
        ...
        <TouchableOpacity onPress={() => setActiveTab("Hosting")}>
          <Text
            style={[
              pinsStyles.navigationText,
              activeTab === "Hosting" && pinsStyles.activeNavigationText,
            ]}
          >
            Hosting
          </Text>
        ...
        <TouchableOpacity onPress={() => setActiveTab("Joined")}>
          <Text
            style={[
              pinsStyles.navigationText,
              activeTab === "Joined" && pinsStyles.activeNavigationText,
            ]}
          >
            Joined
          </Text>
        ...
        <TouchableOpacity onPress={() => setActiveTab("Requested")}>
          <Text
            style={[
              pinsStyles.navigationText,
              activeTab === "Requested" && pinsStyles.activeNavigationText,
            ]}
          >
            Requested
          </Text>
        ...
        <TouchableOpacity onPress={() => setActiveTab("Previous")}>
          <Text
            style={[
              pinsStyles.navigationText,
              activeTab === "Previous" && pinsStyles.activeNavigationText,
            ]}
          >
            Previous
          </Text>
      ...
      {hostedPins.length === 0 ? (
        <View style={pinsStyles.noPinsContainer}>
          <Text style={pinsStyles.noPinsText}>
            You are currently not hosting any pins. Create a pin by tapping on
            the plus sign on the top right.
          </Text>
        </View>
      ) : (
        <Text>You have hosted {hostedPins.length} pins</Text>
      )}
    </View>
  );
};
